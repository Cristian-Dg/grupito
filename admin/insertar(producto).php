...
?>
    ...
    <h1 class='mt-5' align='center'>Insertar Producto</h1>
<?php
	if(!isset($_REQUEST['guardar'])){
		...
		if($errores!=''){
			...
			$idProducto=insertarProducto($nombre,$descripcion,$prioridad);
			if($idProducto==0){
				echo'<div class="alert alert-danger" role="alert">Error al insertar el producto</div>';
				imprimirFormulario($nombre,$introDescripcion,$descripcion,$imagen,$precio,$precioOferta,$online);
			}
			else{
				echo'<div class="alert alert-success" role="alert">El producto '.$idProducto.' ha sido insertado</div>';
