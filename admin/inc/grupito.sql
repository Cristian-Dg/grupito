...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-01-2020 a las 18:00:53
...
ALTER TABLE `detallepedido`
  ...
  ADD KEY `idDetallePedido_2` (`idDetallePedido`);
...
ALTER TABLE `pedidos`
  ...
  ADD CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`idPedido`) REFERENCES `detallepedido` (`idPedido`);
COMMIT;
